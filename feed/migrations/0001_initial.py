    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original', models.IntegerField(default=-1, validators=[feed.models.Validators.validate_origin_post])),
        ...
        migrations.AddField(
            model_name='comment',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_by_user', to='feed.UserProfile'),
        ),
        migrations.CreateModel(
            name='Categorises',
            fields=[
