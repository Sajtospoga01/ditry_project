...
urlpatterns = [
    ...
    path('<username>/folders/<slug:folder_name_slug>/', views.show_folder, name='show_folder'),
    path('<username>/folders/<slug:folder_name_slug>/delete-folder/', views.delete_folder, name='delete_folder'),
    path('<username>/folders/<slug:folder_name_slug>/<post_id>/del-saved-post/', views.delete_saved_post,
